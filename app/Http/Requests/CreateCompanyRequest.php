...
class CreateCompanyRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => __('response.validation.company_name_required'),
            ...
            'description.required' => __('response.validation.description_required'),
            'description.array' => __('response.validation.description_array'),
            'description.en.required' => __('response.validation.description_en_required'),
