...
class CreateListingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'array'],
            'slug.en' => ['nullable', 'string', 'max:255', 'regex:/^[a-z0-9-]+$/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'title.required' => __('response.validation.listing_title_required'),
            'title.array' => __('response.validation.listing_title_array'),
            'title.en.required' => __('response.validation.listing_title_en_required'),
            ...
            'description.required' => __('response.validation.listing_description_required'),
            'description.array' => __('response.validation.listing_description_array'),
            'description.en.required' => __('response.validation.listing_description_en_required'),
            ...
            'location.required' => __('response.validation.listing_location_required'),
            ...
            'listing_type.required' => __('response.validation.listing_type_required'),
            'listing_type.string' => __('response.validation.listing_type_string'),

            // Country code validation messages
            'country_code.required' => __('response.validation.country_code_required'),
