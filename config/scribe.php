...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by logging in via the `/api/auth/login` endpoint. The token should be included in the Authorization header as a Bearer token.',
    ],
